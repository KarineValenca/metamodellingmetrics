...
class MetricsControllerTest < ActionController::TestCase
  ...
  test "should create metric" do
    assert_difference('Metric.count') do
      post :create, metric: { calculus_date: @metric.calculus_date, description_metric: @metric.description_metric, metric_name: @metric.metric_name }
    end
  ...
  test "should update metric" do
    patch :update, id: @metric, metric: { calculus_date: @metric.calculus_date, description_metric: @metric.description_metric, metric_name: @metric.metric_name }
    assert_redirected_to metric_path(assigns(:metric))
  end
